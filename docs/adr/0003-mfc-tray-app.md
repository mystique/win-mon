...
**In scope:** minimal `CWinApp` (or equivalent), hidden message-only / dialog host as needed, `CWnd` (or thin owner-drawn child) for the Rate Strip, tray icon + context menu wiring, timers/messages required for Rate Sample and Shell Recovery.
