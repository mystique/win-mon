...
实现约 3:1 的深色胶囊，主体尺寸为 **144×48 DIP**。左侧圆环内显示 Download Rate 数值和单位；右侧上方显示 Upload Rate，下方显示近期 Download Rate 曲线。
...
- 主体 144×48 DIP，圆角半径 24 DIP，约 3:1。左侧环外径约 39 DIP，主体内留约 4 DIP 边距，线宽约 1.64 DIP，使用圆头端点。
...
主体从 132×44 DIP 适度放大为 144×48 DIP，文字及图形同比放大约 9%，阴影边距仍为 3 DIP。对照原型，左右两端的上下半环及暗轨道均保留约 2 DIP 间隙。以上覆盖早期尺寸收敛记录。
